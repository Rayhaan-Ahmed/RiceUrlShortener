    ...
    return (
        <section className="page">
            ...
            <div className="stats-grid">
                ...
                <article className="stat-card">
                    <span className="stat-label">Signed in user</span>
                    <strong>{user?.name ?? user?.email ?? 'Not set yet'}</strong>
                    <p>The auth flow from master is preserved while the link pages use the backend MVP APIs.</p>
                </article>
